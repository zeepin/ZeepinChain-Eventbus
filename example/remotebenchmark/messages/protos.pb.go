...
func init() {
	proto.RegisterFile("github.com/github.com/zeepin/ZeepinChain-Eventbus/zeepin-eventbus/example/remotebenchmark/messages/protos.proto", fileDescriptorProtos)
}
